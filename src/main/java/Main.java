...
//    }
//
//    public static void logRegistersOfJanitza96(AbstractModbusMaster master) throws ModbusException, IOException, de.re.easymodbus.exceptions.ModbusException {
...
//        log.info("Register " + (currentsMeasuredRegister) + ": [R.E : " + currentsMeasuredRossmannEngineering[0] + " ], [ j2mod : " + currentsMeasuredJ2Mod[0] + " ]");
//        log.info("Register " + (currentsMeasuredRegister + 1) + "3917: [R.E : " + currentsMeasuredRossmannEngineering[1] + " ], [ j2mod : " + currentsMeasuredJ2Mod[1] + " ]");
//        log.info("Register " + (currentsMeasuredRegister + 2) + "3918: [R.E : " + currentsMeasuredRossmannEngineering[2] + " ], [ j2mod : " + currentsMeasuredJ2Mod[2] + " ]");
//
...
//        log.info("Register " + (currentsMeanRegister) + ": [R.E : " + currentsMeanRossmannEngineering[0] + " ], [ j2mod : " + currentsMeanJ2Mod[0] + " ]");
//        log.info("Register " + (currentsMeanRegister + 1) + ": [R.E : " + currentsMeanRossmannEngineering[1] + " ], [ j2mod : " + currentsMeanJ2Mod[1] + " ]");
//        log.info("Register " + (currentsMeanRegister + 2) + ": [R.E : " + currentsMeanRossmannEngineering[2] + " ], [ j2mod : " + currentsMeanJ2Mod[2] + " ]");
//
...
//        log.info("Register " + (voltageMeasuredRegister) + ": [R.E : " + voltageMeasuredRossmannEngineering[0] + " ], [ j2mod : " + voltageMeasuredJ2Mod[0] + " ]");
//        log.info("Register " + (voltageMeasuredRegister + 1) + ": [R.E : " + voltageMeasuredRossmannEngineering[1] + " ], [ j2mod : " + voltageMeasuredJ2Mod[1] + " ]");
//        log.info("Register " + (voltageMeasuredRegister + 2) + ": [R.E : " + voltageMeasuredRossmannEngineering[2] + " ], [ j2mod : " + voltageMeasuredJ2Mod[2] + " ]");
//
//
...
//        log.info("Register " + (voltageMeanRegister) + ": [R.E : " + voltageMeanRossmannEngineering[0] + " ], [ j2mod : " + voltageMeanJ2Mod[0] + " ]");
//        log.info("Register " + (voltageMeanRegister + 1) + ": [R.E : " + voltageMeanRossmannEngineering[1] + " ], [ j2mod : " + voltageMeanJ2Mod[1] + " ]");
//        log.info("Register " + (voltageMeanRegister + 2) + ": [R.E : " + voltageMeanRossmannEngineering[2] + " ], [ j2mod : " + voltageMeanJ2Mod[2] + " ]");
//
//
...
//        log.info("Register " + (powerActiveMeasuredRegister) + ": [R.E : " + powerActiveMeasuredRossmannEngineering[0] + " ], [ j2mod : " + powerActiveMeasuredJ2Mod[0] + " ]");
//        log.info("Register " + (powerActiveMeasuredRegister + 1) + ": [R.E : " + powerActiveMeasuredRossmannEngineering[1] + " ], [ j2mod : " + powerActiveMeasuredJ2Mod[1] + " ]");
//        log.info("Register " + (powerActiveMeasuredRegister + 2) + ": [R.E : " + powerActiveMeasuredRossmannEngineering[2] + " ], [ j2mod : " + powerActiveMeasuredJ2Mod[2] + " ]");
//
//
...
//        log.info("Register " + (powerActiveMeanRegister) + ": [R.E : " + powerActiveMeanRossmannEngineering[0] + " ], [ j2mod : " + powerActiveMeanJ2Mod[0] + " ]");
//        log.info("Register " + (powerActiveMeanRegister + 1) + ": [R.E : " + powerActiveMeanRossmannEngineering[1] + " ], [ j2mod : " + powerActiveMeanJ2Mod[1] + " ]");
//        log.info("Register " + (powerActiveMeanRegister + 2) + ": [R.E : " + powerActiveMeanRossmannEngineering[2] + " ], [ j2mod : " + powerActiveMeanJ2Mod[2] + " ]");
//
//
...
//        log.info("Register " + (powerReactiveMeasuredRegister) + ": [R.E : " + powerReactiveMeasuredRossmannEngineering[0] + " ], [ j2mod : " + powerReactiveMeasuredJ2Mod[0].toShort() + " ]");
//        log.info("Register " + (powerReactiveMeasuredRegister + 1) + ": [R.E : " + powerReactiveMeasuredRossmannEngineering[1] + " ], [ j2mod : " + powerReactiveMeasuredJ2Mod[1].toShort() + " ]");
//        log.info("Register " + (powerReactiveMeasuredRegister + 2) + ": [R.E : " + powerReactiveMeasuredRossmannEngineering[2] + " ], [ j2mod : " + powerReactiveMeasuredJ2Mod[2].toShort() + " ]");
//
...
//        log.info("Register " + (powerReactiveMeanRegister) + ": [R.E : " + powerReactiveMeanRossmannEngineering[0] + " ], [ j2mod : " + powerReactiveMeanJ2Mod[0].toShort() + " ]");
//        log.info("Register " + (powerReactiveMeanRegister + 1) + ": [R.E : " + powerReactiveMeanRossmannEngineering[1] + " ], [ j2mod : " + powerReactiveMeanJ2Mod[1].toShort() + " ]");
//        log.info("Register " + (powerReactiveMeanRegister + 2) + ": [R.E : " + powerReactiveMeanRossmannEngineering[2] + " ], [ j2mod : " + powerReactiveMeanJ2Mod[2].toShort() + " ]");
//        log.info("====================");
//    }
//
//
